...
class CAR(Platforms):
  ...
  KIA_CEED_2021 = HyundaiPlatformConfig(
    [HyundaiCarDocs("Kia Ceed/ProCeed 2021", car_parts=CarParts.common([CarHarness.hyundai_e]))],
    KIA_CEED.specs,
...
FW_QUERY_CONFIG = FwQueryConfig(
  ...
  non_essential_ecus={
    Ecu.abs: [CAR.HYUNDAI_PALISADE, CAR.HYUNDAI_SONATA, CAR.HYUNDAI_SANTA_FE_2022, CAR.KIA_K5_2021, CAR.HYUNDAI_ELANTRA_2021,
              ...
              CAR.KIA_CEED, CAR.KIA_CEED_2021, CAR.KIA_SELTOS],
  },
  extra_ecus=[
